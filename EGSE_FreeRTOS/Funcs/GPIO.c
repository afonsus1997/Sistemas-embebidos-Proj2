...
void vHardwareIOInit(){
    ...
    ROM_GPIOPinTypeGPIOOutput(GPIO_PORTA_BASE, BAT_CHARGE_EN | CS_ADC2 | CS1_GPIO_EX);
    ...
    ROM_GPIOPinTypeGPIOOutput(GPIO_PORTE_BASE, CS_ADC1);
    ...
    ROM_GPIOPadConfigSet(GPIO_PORTB_BASE, GPIO_PIN_6, GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPU);
