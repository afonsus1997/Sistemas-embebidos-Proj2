...
uint8_t adc0PinMap[15] = {BAT_I, BAT_V, EGSE_ADC1, EGSE_ADC2, EGSE_ADC3, EGSE_ADC4, EGSE_ADC5, EGSE_ADC6, EGSE_ADC7, EGSE_ADC8, ADC_V6_VAL, ADC_I6_VAL, ADC_I4_VAL, ADC_V4_VAL, -1};
uint8_t adc1PinMap[15] = {ADC_V2_VAL, ADC_I2_VAL, ADC_V5_VAL, ADC_V3_VAL, ADC_I3_VAL, ADC_V1_VAL, ADC_I1_VAL, -1, -1, -1, EXP_ADC1_VAL, EXP_ADC2_VAL, EXP_ADC3_VAL, EXP_ADC4_VAL, -1};
...
//        }
        ...
        if(adc0PinMap[i] != -1){ //sets the read value range
